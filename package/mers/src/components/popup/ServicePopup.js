          ...
          <div className="service_popup_informations">
            ...
            <div className="descriptions">
              ...
              <p>
                ...
                website{`’s`} design but also partnering with Mer{`'s`}, the web
                design agency that
                {`’s`} driven more than $2.4 billion in revenue for its clients.
                With over 50 web design awards under our belt,{` we're`}
